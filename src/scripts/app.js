...
window.onload = async () => {
	const $style = document.getElementById(`${lesrapporteuses.text_domain}-main-css`);
	...
	if ($style) {
		...
		console.warn(`The "${lesrapporteuses.text_domain}-main-css" stylesheet not found`);
	}
};
