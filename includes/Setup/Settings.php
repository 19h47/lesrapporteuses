...
namespace LesRapporteuses\Setup;
	...
	public function settings_api_init() : void {
		...
		add_settings_field(
			...
			array(
				...
				'description' => __( 'Enter the Facebook URL here.', 'lesrapporteuses' ),
			)
		);

		add_settings_field(
			'twitter',
			__( 'Twitter', 'lesrapporteuses' ),
			array( $this, 'text_callback_function' ),
			'general',
			'socials',
			array(
				...
				'description' => __( 'Enter the Twitter URL here.', 'lesrapporteuses' ),
			)
		);

		add_settings_field(
			'instagram',
			__( 'Instagram', 'lesrapporteuses' ),
			array( $this, 'text_callback_function' ),
			'general',
			'socials',
			array(
				...
				'description' => __( 'Enter the Instagram URL here.', 'lesrapporteuses' ),
			)
		);

		add_settings_field(
			'public_email',
			__( 'Public Email Address', 'lesrapporteuses' ),
			...
			array(
				...
				'description' => __( 'This address is used for public purposes.', 'lesrapporteuses' ),
		...
		add_settings_field(
			'page_for_search',
			__( 'Search page', 'lesrapporteuses' ),
			array( $this, 'dropdown_pages_callback_function' ),
			'reading',
			'default',
			array(
		...
		add_settings_field(
			'page_for_apply',
			__( 'Apply page', 'lesrapporteuses' ),
			array( $this, 'url_callback_function' ),
			'reading',
			'default',
			array(
				'name'        => 'page_for_apply',
				'label'       => __( 'Apply page', 'lesrapporteuses' ),
				'description' => __( 'This is the URL where the application form is located.', 'lesrapporteuses' ),
		...
		add_settings_field(
			'mailchimp_id',
			__( 'Mailchimp ID', 'lesrapporteuses' ),
			array( $this, 'text_callback_function' ),
			'general',
			'default',
			array(
				...
				'description' => __( 'Enter the Mailchimp ID here.', 'lesrapporteuses' ),
			)
		);

		add_settings_field(
			'mailchimp_user_id',
			__( 'Mailchimp User ID', 'lesrapporteuses' ),
			array( $this, 'text_callback_function' ),
			'general',
			'default',
			array(
				...
				'description' => __( 'Enter the Mailchimp user ID here.', 'lesrapporteuses' ),
			)
		);

		add_settings_field(
			'mailchimp_form_id',
			__( 'Mailchimp Form ID', 'lesrapporteuses' ),
			array( $this, 'text_callback_function' ),
			'general',
			'default',
			array(
				...
				'description' => __( 'Enter the Mailchimp form ID here.', 'lesrapporteuses' ),
			)
		);
	}
