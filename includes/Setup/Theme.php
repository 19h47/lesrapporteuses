 ...
 *
 * @package WordPress
 * @subpackage LesRapporteuses/Setup/Theme
 */
	...
	public function add_socials_to_context( array $context ) : array {
		...
		$socials = array(
			...
			array(
				'title' => 'Twitter',
				'slug'  => 'twitter',
				'name'  => __( 'Share on Twitter', 'lesrapporteuses' ),
			...
			array(
				'title' => 'Facebook',
				'slug'  => 'facebook',
				'name'  => __( 'Share on Facebook', 'lesrapporteuses' ),
			...
			array(
				'title' => 'LinkedIn',
				'slug'  => 'linkedin',
				'name'  => __( 'Share on LinkedIn', 'lesrapporteuses' ),
